...
def vgaunchain():
	ports.outb(4, 0x3CE); ports.outb(0x2, 0x3CF)
	ports.writevec(0x3C4,0x3C5,  3,1,4,0,6) # 6 for mode X
	ports.writevec(0x3D4,0x3D5,
		0x5f, 0x4f, 0x50, 0x82,  0x54, 0x80, 0xbf, 0x1f,
		0x00, 0x41, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
...
def vgarechain():
	ports.outb(4, 0x3CE); ports.outb(0x0, 0x3CF)
	ports.writevec(0x3C4,0x3C5,  3,1,0xf,0,0xe) # 6 for mode X
	ports.writevec(0x3D4,0x3D5,
		0x5f, 0x4f, 0x50, 0x82,  0x54, 0x80, 0xbf, 0x1f,
		0x00, 0x41, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
